 ...
 * @generated
 */
public class TradeServiceClp implements TradeService {
    ...
    public TradeServiceClp(InvokableService invokableService) {
        ...
        _methodName3 = "addTrade";

        _methodParameterTypes3 = new String[] { "java.lang.String" };

        _methodName4 = "createTradeFromJSON";
