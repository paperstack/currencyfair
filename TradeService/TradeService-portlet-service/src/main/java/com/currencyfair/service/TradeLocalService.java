...
/**
 * Provides the local service interface for Trade. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TradeLocalServiceUtil
...
public interface TradeLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link TradeLocalServiceUtil} to access the trade local service. Add custom service methods to {@link com.currencyfair.service.impl.TradeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
